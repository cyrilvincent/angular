...
/* harmony import */ var _shared_pwa_services__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shared/pwa-services */ "./src/app/shared/pwa-services.ts");
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_pwa_services__WEBPACK_IMPORTED_MODULE_3__["LogUpdateService"], _shared_pwa_services__WEBPACK_IMPORTED_MODULE_3__["UpdateService"]])
], AppComponent);
...
/* harmony import */ var _shared_in_memory_data_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./shared/in-memory-data.service */ "./src/app/shared/in-memory-data.service.ts");
...
/* harmony import */ var _angular_service_worker__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @angular/service-worker */ "./node_modules/@angular/service-worker/fesm2015/service-worker.js");
/* harmony import */ var _unless_directive__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./unless.directive */ "./src/app/unless.directive.ts");
...
let AppModule = class AppModule {
    InMemoryWebApiForRoot() {
        angular_in_memory_web_api__WEBPACK_IMPORTED_MODULE_14__["HttpClientInMemoryWebApiModule"].forRoot(_shared_in_memory_data_service__WEBPACK_IMPORTED_MODULE_15__["InMemoryDataService"], { dataEncapsulation: false });
    }
};
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _unless_directive__WEBPACK_IMPORTED_MODULE_20__["UnlessDirective"],
        ],
        imports: [
            ...
            _environments_environment__WEBPACK_IMPORTED_MODULE_18__["environment"].production ? [] : angular_in_memory_web_api__WEBPACK_IMPORTED_MODULE_14__["HttpClientInMemoryWebApiModule"].forRoot(_shared_in_memory_data_service__WEBPACK_IMPORTED_MODULE_15__["InMemoryDataService"], { dataEncapsulation: false }),
            _angular_service_worker__WEBPACK_IMPORTED_MODULE_19__["ServiceWorkerModule"].register('ngsw-worker.js', { enabled: _environments_environment__WEBPACK_IMPORTED_MODULE_18__["environment"].production })
        ],
...
let CartComponent = class CartComponent {
    ...
    ngOnInit() {
        this.gameService.changeEmitted$.subscribe(cart => this.nbElement = cart.games.length);
    }
};
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _shared_video_game__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/video-game */ "./src/app/shared/video-game.ts");
...
let GameCreateComponent = class GameCreateComponent {
    constructor(gameService, location) {
        this.gameService = gameService;
        this.location = location;
        this.game = new _shared_video_game__WEBPACK_IMPORTED_MODULE_2__["VideoGame"]();
    }
    ngOnInit() {
        this.game.year = 1970;
        this.game.consoles = [];
...
GameCreateComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_game_service__WEBPACK_IMPORTED_MODULE_3__["GameService"],
...
let GameDetailComponent = class GameDetailComponent {
    ...
    constructor(gameService, route, location) {
        this.gameService = gameService;
        this.route = route;
        this.location = location;
    }
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _shared_video_game__WEBPACK_IMPORTED_MODULE_2__["VideoGame"])
...
GameDetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_game_service__WEBPACK_IMPORTED_MODULE_3__["GameService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["Location"]])
], GameDetailComponent);
...
let GamesSearchComponent = class GamesSearchComponent {
    constructor(gameService) {
        this.gameService = gameService;
    ...
    ngOnInit() {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((term) => this.gameService.searchGames(term)));
    }
};
GamesSearchComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_game_service__WEBPACK_IMPORTED_MODULE_4__["GameService"]])
...
let GamesComponent = class GamesComponent {
    constructor(gameService) {
        this.gameService = gameService;
        this.newGame = new _shared_video_game__WEBPACK_IMPORTED_MODULE_2__["VideoGame"]();
    }
    ngOnInit() {
        this.getGames();
    }
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _shared_message_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/message.service */ "./src/app/shared/message.service.ts");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _mock_video_games__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mock-video-games */ "./src/app/shared/mock-video-games.ts");
/* harmony import */ var _video_game__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./video-game */ "./src/app/shared/video-game.ts");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
/* harmony import */ var _message_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./message.service */ "./src/app/shared/message.service.ts");
...
const httpOptions = {
    headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpHeaders"]({ 'Content-Type': 'application/json' })
};
let GameService = class GameService {
    constructor(messageService, http) {
        this.messageService = messageService;
        this.http = http;
        this._cart = new _video_game__WEBPACK_IMPORTED_MODULE_3__["Cart"]();
        this.emitChangeSource = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        this.changeEmitted$ = this.emitChangeSource.asObservable();
    }
    get cart$() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(this._cart);
    }
    getGames() {
        this.messageService.add('GameService: fetched games');
        console.log(_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].gamesUrl);
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].gamesUrl);
    }
    getGame(id) {
        this.messageService.add(`GameService: fetched game id=${id}`);
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].gamesUrl}/${id}`);
    }
    getTop4() {
        this.messageService.add('GameService: fetched TOP4 games');
        return this.getGames().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(games => games.sort((x, y) => y.nbView - x.nbView).slice(0, 4)));
    }
    incrementNbView(game) {
        game.nbView++;
        console.log(`Game.nbView++ ${game.id}`);
        console.log(_mock_video_games__WEBPACK_IMPORTED_MODULE_2__["VIDEOGAMES"]);
    }
    addToCart(game) {
    ...
    updateGame(game) {
        ...
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].gamesUrl, game, httpOptions);
    }
    addGame(game) {
        console.log(`add game id=${game.id} ${game.title}`);
        return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].gamesUrl, game, httpOptions);
    }
    deleteGame(id) {
        console.log(`delete game id=${id}`);
        return this.http.delete(`${_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].gamesUrl}/${id}`, httpOptions);
    }
    searchGames(term) {
        if (!term.trim()) {
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].production) {
            return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].gamesUrl}/search?q=${term}`);
        }
        else {
            return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].gamesUrl}/?title=${term}`);
        }
    }
};
GameService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_message_service__WEBPACK_IMPORTED_MODULE_6__["MessageService"],
...
/***/ "./src/app/shared/mock-video-games.ts":
/*!********************************************!*\
  !*** ./src/app/shared/mock-video-games.ts ***!
  \********************************************/
...
/***/ "./src/app/shared/pwa-services.ts":
/*!****************************************!*\
  !*** ./src/app/shared/pwa-services.ts ***!
  \****************************************/
...
let UpdateService = class UpdateService {
    constructor(updates) {
        ...
        if (updates.isEnabled) {
            Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(6 * 60 * 60 * 1000).subscribe(() => updates.checkForUpdate()
...
UnlessDirective = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Directive"])({ selector: '[appUnless]' }),
