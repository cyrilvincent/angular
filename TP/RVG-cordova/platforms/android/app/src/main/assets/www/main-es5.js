...
var GameService = /** @class */ (function () {
    ...
    GameService.prototype.getTop4 = function () {
        ...
        return this.getGames().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (games) { return games.sort(function (x, y) { return y.nbView - x.nbView; }).slice(0, 4); }));
    };
    GameService.prototype.incrementNbView = function (game) {
        game.nbView++;
...
var UpdateService = /** @class */ (function () {
    function UpdateService(updates) {
        ...
        if (updates.isEnabled) {
            Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(6 * 60 * 60 * 1000).subscribe(function () { return updates.checkForUpdate()
                .then(function () { return console.log('checking for updates'); }); });
        }
    }
    UpdateService.prototype.checkForUpdates = function () {
        var _this = this;
        this.updates.available.subscribe(function (_) { return _this.promptUser(); });
    };
