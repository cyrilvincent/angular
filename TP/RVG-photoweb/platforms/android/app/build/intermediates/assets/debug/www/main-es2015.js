...
let GameService = class GameService {
    ...
    getTop4() {
        ...
        return this.getGames().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(games => games.sort((x, y) => y.nbView - x.nbView).slice(0, 4)));
    }
    get cart$() {
...
let UpdateService = class UpdateService {
    constructor(updates) {
        ...
        if (updates.isEnabled) {
            Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(6 * 60 * 60).subscribe(() => updates.checkForUpdate()
...
let HttpErrorInterceptor = class HttpErrorInterceptor {
    ...
    intercept(request, next) {
        return next.handle(request)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])((error, caught) => {
            if (!navigator.onLine) {
